...
namespace Islands.PCG.Samples
{
    ...
    ///
    /// W-aux.b: sea-floor relief step added — must stay identical to Stage_BaseTerrain2D.
    ///
    /// W-aux.f: height ceiling de-saturation (normalize by 1 + terrainAmp/2) — the
    ...
    public sealed class BaseTerrainStage_Configurable : IMapStage2D
    {
        ...
        public void Execute(ref MapContext2D ctx, in MapInputs inputs)
        {
            ...
            // W-aux.f: height ceiling de-saturation — mirrors Stage_BaseTerrain2D exactly.
            float terrainNormScale = 1f / (1f + terrainAmp * 0.5f);

            // W-aux.b: sea-floor relief — mirrors Stage_BaseTerrain2D exactly.
            ...
            try
            {
                ...
                for (int y = 0; y < h; y++)
                {
                    ...
                    for (int x = 0; x < w; x++)
                    {
                        ...
                        // W-aux.b: sea-floor relief — lower bound on sub-threshold
