...
{
    /// <summary>
    /// Pipeline golden for the full F0-M2a (vegetation after biome)�M pipeline.
    ...
    /// </summary>
    public sealed class MapPipelineRunner2DGoldenM2Tests
    {
        ...
        // W-aux.f re-lock. Moisture / Biome not yet revealed — chained asserts stop at
        // the first failure; a second run will surface them.
        ...
        [Test]
        public void Pipeline_M2a_GoldenHash_IsLocked()
        {
        ...
        [Test]
        public void Pipeline_M2a_DoesNotInvalidate_G_Goldens()
        {
