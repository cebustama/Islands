> **Status:** Historical support / superseded source  
> **Superseded by:** `Documentation~/systems/pcg-core-ssot.md`, `Documentation~/systems/map-pipeline-by-layers-ssot.md`  
> **Absorbed into:** `Documentation~/reference/overview.md`, `Documentation~/reference/noise.md`, `Documentation~/reference/mesh.md`, `Documentation~/reference/shaders.md`  
> **Authority note:** This file remains in the frozen snapshot as source history. It is not active subsystem authority.
