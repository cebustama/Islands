...
Status: Archived — all items resolved  
Authority: Historical planning reference. No longer active.  
Resolution: N1 = Phase J2 (done). N2 = Phase N2 (done). N3 = Phase N5.c (done, Option A1).  
Home: `Documentation~/planning/archive/`
...
| N3 | Ridged Multifractal (full Musgrave) | **Done (Phase N5.c, Option A1)** | High | Medium |
...
DONE
  └─ N3: Ridged Multifractal ───── Phase N5.c (implemented, Option A1)
                                    FractalMode + ridgedOffset + ridgedGain on Noise.Settings.
                                    GetRidgedFractalNoise<N>() in noise runtime.
                                    Musgrave algorithm. Applies to all INoise types.
```
...
All three items are resolved. This roadmap is archived.
