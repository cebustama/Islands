# Islands.PCG — Map Pipeline by Layers Integration Roadmap (Historical Archive)

> **Status:** Historical support / absorbed planning source  
> **Date retained in archive:** 2026-03-31  
> **Superseded by:** `Documentation~/planning/active/PCG_Roadmap.md` as the active planning surface  
> **Authority note:** This file is preserved in governed archive form for planning traceability. It is **not** implementation truth and it is **not** the active roadmap.
